...
\textbf{V.23}
Pour la fonction \texttt{inv\_simple\_simple}, j'ai réussi à prouver la
précondition de l'appel à la fonction \texttt{ediv\_mod}, mais je ne suis pas
parvenu à prouver, la post-condition.
...
\textbf{V.27}
Je ne suis pas non plus parvenu à prouver la terminaison de la fonction \texttt{compute}.
En utilisant l'aide donnée dans le sujet, j'ai été capable de prouver le résultat de la fonction \texttt{exists\_m\_term} pour l'existence d'un $m$ suffisamment grand.
Toutefois, je n'ai pas pu le mettre à profit pour la terminaison.
